...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 28-02-2025 a las 00:20:38
...
(0, 'Comidas blandas', 'Comiditas del patrón');
...
(1, 'madrid1@empresa.com', '$2y$10$3w1M3PjsbhhTo9J5nUPLBu7cP2ziomz/nFJwCDYfniN4XKln3Slf2', 'España', 28002, 'Madrid', 'C/ Padre  Claret, 8', 0),
(2, 'cadiz1@empresa.com', '$2y$10$BdPsqn0WO9yXEdinoBbEbOBfKgC6DGKy5vtIZGmDiYvg6NIiDuai.', 'España', 11001, 'Cádiz', 'C/ Portales, 2 ', 0),
(3, 'dwes@afleal.es', '$2y$10$atwftxp/jJZk9O5IJi4zPOoH./9.4jsyTTaVy2CTQMYAf/SkNKcXC', 'España', 15001, 'A Coruña', 'Plaza de María Pita, 1', 1);
...
--
ALTER TABLE `pedidosproductos`
  MODIFY `CodPredProd` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
